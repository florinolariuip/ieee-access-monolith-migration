...
The skill abstraction is statistically indistinguishable from a
vague-prompt baseline in single-shot alignment quality, but halves
the practitioner-facing failure rate (10\% vs.\ 20\%) and removes
the prompt-engineering burden. The wrapper's value is reliability
and ergonomics, not better LLM output.
